...
[wxID_KK_SEMENTARA, wxID_KK_SEMENTARABUTTON1, wxID_KK_SEMENTARADESA, 
 ...
 wxID_KK_SEMENTARALABEL_DATA_PENDUDUK, wxID_KK_SEMENTARALABEL_DIFABELITAS, 
 wxID_KK_SEMENTARALABEL_DUSUN, wxID_KK_SEMENTARALABEL_GOLONGAN_DARAH, 
 wxID_KK_SEMENTARALABEL_JENIS_KELAMIN, wxID_KK_SEMENTARALABEL_KEWARGANEGARAAN, 
 wxID_KK_SEMENTARALABEL_KONTRASEPSI, wxID_KK_SEMENTARALABEL_NAMA_AYAH, 
 wxID_KK_SEMENTARALABEL_NAMA_IBU, wxID_KK_SEMENTARALABEL_NAMA_LENGKAP, 
 wxID_KK_SEMENTARALABEL_NOMOR_KK, wxID_KK_SEMENTARALABEL_PEKERJAAN, 
 wxID_KK_SEMENTARALABEL_PEKERJAAN_LAINNYA, 
...
class kk_sementara(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(self, id=wxID_KK_SEMENTARA, name=u'kk_sementara',
              parent=prnt, pos=wx.Point(406, 79), size=wx.Size(888, 639),
              style=wx.TAB_TRAVERSAL, title=u'Tambah Kartu Keluarga Sementara')
        ...
        self.pilihan_jenis_kelamin = wx.ComboBox(choices=['L',
              'P'], id=wxID_KK_SEMENTARAPILIHAN_JENIS_KELAMIN,
        ...
        self.label_data_penduduk = wx.StaticText(id=wxID_KK_SEMENTARALABEL_DATA_PENDUDUK,
        ...
        self.dokumen1 = wx.ComboBox(choices=['Akta Kelahiran'], id=wxID_KK_SEMENTARADOKUMEN1, name=u'dokumen1',
              parent=self, pos=wx.Point(24, 464), size=wx.Size(187, 27),
              style=0, value='')

        self.dokumen2 = wx.ComboBox(choices=['Akta Nikah'], id=wxID_KK_SEMENTARADOKUMEN2, name=u'dokumen2',
              parent=self, pos=wx.Point(24, 504), size=wx.Size(187, 27),
              style=0, value='')

        self.dokumen3 = wx.ComboBox(choices=['Akta Cerai'], id=wxID_KK_SEMENTARADOKUMEN3, name=u'dokumen3',
              parent=self, pos=wx.Point(224, 464), size=wx.Size(187, 27),
              style=0, value='')

        self.dokumen4 = wx.ComboBox(choices=['Akta Kematian'], id=wxID_KK_SEMENTARADOKUMEN4, name=u'dokumen4',
              parent=self, pos=wx.Point(224, 504), size=wx.Size(187, 27),
              style=0, value='')

        self.dokumen5 = wx.ComboBox(choices=['KTP Sementara'], id=wxID_KK_SEMENTARADOKUMEN5, name=u'dokumen5',
              parent=self, pos=wx.Point(424, 464), size=wx.Size(187, 27),
              style=0, value='')

        self.dokumen6 = wx.ComboBox(choices=['KITAS'], id=wxID_KK_SEMENTARADOKUMEN6, name=u'dokumen6',
              parent=self, pos=wx.Point(424, 504), size=wx.Size(187, 27),
              style=0, value='')

        self.dokumen7 = wx.ComboBox(choices=['VISA'], id=wxID_KK_SEMENTARADOKUMEN7, name=u'dokumen7',
              parent=self, pos=wx.Point(632, 464), size=wx.Size(187, 27),
              style=0, value='')

        self.dokumen8 = wx.ComboBox(choices=['Paspor'], id=wxID_KK_SEMENTARADOKUMEN8, name=u'dokumen8',
        ...
        self.tombol_tambah_data = wx.Button(id=wxID_KK_SEMENTARATOMBOL_TAMBAH_DATA,
              ...
              pos=wx.Point(248, 600), size=wx.Size(200, 32), style=0)
        ...
        self.kembali = wx.Button(id=wxID_KK_SEMENTARAKEMBALI,
              ...
              pos=wx.Point(480, 600), size=wx.Size(208, 32), style=0)
