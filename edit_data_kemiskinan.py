#Boa:Frame:edit_data_kemiskinan
...
def create(parent):
    return edit_data_kemiskinan(parent)
...
class edit_data_kemiskinan(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.cari_kk = wx.TextCtrl(id=wxID_EDIT_DATA_KEMISKINANCARI_KK,
              name=u'cari_kk', parent=self, pos=wx.Point(560, 200),
              size=wx.Size(168, 25), style=0, value='')

        self.button1 = wx.Button(id=wxID_EDIT_DATA_KEMISKINANBUTTON1,
              label=u'Cari', name='button1', parent=self, pos=wx.Point(744,
              200), size=wx.Size(80, 24), style=0)

        self.staticText2 = wx.StaticText(id=wxID_EDIT_DATA_KEMISKINANSTATICTEXT2,
        ...
        self.status_miskin = wx.ComboBox(choices=['Miskin', 'Tidak Miskin'],
              id=wxID_EDIT_DATA_KEMISKINANSTATUS_MISKIN, name=u'status_miskin',
              parent=self, pos=wx.Point(552, 264), size=wx.Size(272, 25),
              style=0, value='')

        self.staticText6 = wx.StaticText(id=wxID_EDIT_DATA_KEMISKINANSTATICTEXT6,
