...
def create(parent):
    return kejadian_kematian(parent)

[wxID_KEJADIAN_KEMATIAN, wxID_KEJADIAN_KEMATIANCARI_KK, 
 wxID_KEJADIAN_KEMATIANDOKUMEN, wxID_KEJADIAN_KEMATIANINPUT_ALAMAT, 
 wxID_KEJADIAN_KEMATIANINPUT_AYAH, wxID_KEJADIAN_KEMATIANINPUT_DUSUN, 
 wxID_KEJADIAN_KEMATIANINPUT_IBU, wxID_KEJADIAN_KEMATIANINPUT_NAMA, 
 wxID_KEJADIAN_KEMATIANINPUT_NIK, wxID_KEJADIAN_KEMATIANINPUT_NO, 
 wxID_KEJADIAN_KEMATIANINPUT_NO_KK, wxID_KEJADIAN_KEMATIANINPUT_RT, 
 wxID_KEJADIAN_KEMATIANINPUT_RW, wxID_KEJADIAN_KEMATIANINPUT_TEMPAT_LAHIR, 
 wxID_KEJADIAN_KEMATIANISIPENDUDUK, wxID_KEJADIAN_KEMATIANKEMBALI, 
 wxID_KEJADIAN_KEMATIANKETERANGAN, wxID_KEJADIAN_KEMATIANLABEL_AGAMA, 
 wxID_KEJADIAN_KEMATIANLABEL_ALAMAT, 
 wxID_KEJADIAN_KEMATIANLABEL_DATA_PENDUDUK, 
 wxID_KEJADIAN_KEMATIANLABEL_DIFABELITAS, wxID_KEJADIAN_KEMATIANLABEL_DUSUN, 
 wxID_KEJADIAN_KEMATIANLABEL_GOLONGAN_DARAH, 
 wxID_KEJADIAN_KEMATIANLABEL_JENIS_KELAMIN, 
 wxID_KEJADIAN_KEMATIANLABEL_KEWARGANEGARAAN, 
 wxID_KEJADIAN_KEMATIANLABEL_KONTRASEPSI, 
 wxID_KEJADIAN_KEMATIANLABEL_NAMA_AYAH, wxID_KEJADIAN_KEMATIANLABEL_NAMA_IBU, 
 wxID_KEJADIAN_KEMATIANLABEL_NAMA_LENGKAP, 
 wxID_KEJADIAN_KEMATIANLABEL_NOMOR_KK, wxID_KEJADIAN_KEMATIANLABEL_PEKERJAAN, 
 wxID_KEJADIAN_KEMATIANLABEL_PEKERJAAN_LAINNYA, 
 wxID_KEJADIAN_KEMATIANLABEL_PENDIDIKAN_TEMPUH, 
 wxID_KEJADIAN_KEMATIANLABEL_PENDIDIKAN_TERAKHIR, 
 wxID_KEJADIAN_KEMATIANLABEL_RESIKO_KEHAMILAN, 
 wxID_KEJADIAN_KEMATIANLABEL_SHDK, 
 wxID_KEJADIAN_KEMATIANLABEL_STATUS_KEPENDUDUKAN, 
 wxID_KEJADIAN_KEMATIANLABEL_STATUS_PERKAWINAN, 
 wxID_KEJADIAN_KEMATIANLABEL_STATUS_TINGGAL, 
 wxID_KEJADIAN_KEMATIANLABEL_TANGGAL_LAHIR, 
 wxID_KEJADIAN_KEMATIANLABEL_TEMPAT_LAHIR, wxID_KEJADIAN_KEMATIANLAPORAN, 
 wxID_KEJADIAN_KEMATIANLEBEL_NIK, wxID_KEJADIAN_KEMATIANNAMAPENGGANTI, 
 wxID_KEJADIAN_KEMATIANNAMA_KK, wxID_KEJADIAN_KEMATIANPILIHAN_AGAMA, 
 wxID_KEJADIAN_KEMATIANPILIHAN_DIFABELITAS, 
 wxID_KEJADIAN_KEMATIANPILIHAN_GOLONGAN_DARAH, 
 wxID_KEJADIAN_KEMATIANPILIHAN_JENIS_KELAMIN, 
 wxID_KEJADIAN_KEMATIANPILIHAN_KEHAMILAN, 
 wxID_KEJADIAN_KEMATIANPILIHAN_KONTRASEPSI, 
 wxID_KEJADIAN_KEMATIANPILIHAN_PEKERJAAN, 
 wxID_KEJADIAN_KEMATIANPILIHAN_PEKERJAAN_LAINNYA, 
 wxID_KEJADIAN_KEMATIANPILIHAN_PENDIDIKAN_DITEMPUH, 
 wxID_KEJADIAN_KEMATIANPILIHAN_PENDIDIKAN_TERAKHIR, 
 wxID_KEJADIAN_KEMATIANPILIHAN_SHDK, wxID_KEJADIAN_KEMATIANPILIHAN_STATUS, 
 wxID_KEJADIAN_KEMATIANPILIHAN_STATUS_KEPENDUDUKAN, 
 wxID_KEJADIAN_KEMATIANPILIHAN_STATUS_TINGGAL, 
 wxID_KEJADIAN_KEMATIANPILIHAN_WARGANEGARA, 
 wxID_KEJADIAN_KEMATIANSIMPANGAMBAR, wxID_KEJADIAN_KEMATIANSTATICTEXT1, 
 wxID_KEJADIAN_KEMATIANSTATICTEXT2, wxID_KEJADIAN_KEMATIANSTATICTEXT3, 
 wxID_KEJADIAN_KEMATIANSTATICTEXT4, wxID_KEJADIAN_KEMATIANSTATICTEXT5, 
 wxID_KEJADIAN_KEMATIANSTATICTEXT6, wxID_KEJADIAN_KEMATIANSTATICTEXT7, 
 wxID_KEJADIAN_KEMATIANTANGGALKEJADIAN, wxID_KEJADIAN_KEMATIANTANGGALKEMATIAN, 
 wxID_KEJADIAN_KEMATIANTANGGAL_LAHIR, wxID_KEJADIAN_KEMATIANTGLKEJADIAN, 
 wxID_KEJADIAN_KEMATIANTOMBOL_CARI, wxID_KEJADIAN_KEMATIANTOMBOL_TAMBAH_DATA, 
] = [wx.NewId() for _init_ctrls in range(74)]

class kejadian_kematian(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Dialog.__init__(self, id=wxID_KEJADIAN_KEMATIAN,
              name=u'edit_kejadian_kematian', parent=prnt, pos=wx.Point(406,
              79), size=wx.Size(888, 639), style=wx.FRAME_NO_TASKBAR,
              title=u'Kejadian Kematian')
        self.SetClientSize(wx.Size(888, 639))
        self.Center(wx.BOTH)

        self.label_nomor_kk = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_NOMOR_KK,
              label=u'Nomor KK', name=u'label_nomor_kk', parent=self,
              pos=wx.Point(8, 152), size=wx.Size(168, 17),
              style=wx.TE_READONLY)

        self.label_alamat = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_ALAMAT,
        ...
        self.pilihan_jenis_kelamin = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANPILIHAN_JENIS_KELAMIN,
              name=u'pilihan_jenis_kelamin', parent=self, pos=wx.Point(192,
              288), size=wx.Size(200, 27), style=wx.TE_READONLY, value=u'')

        self.input_tempat_lahir = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANINPUT_TEMPAT_LAHIR,
              name=u'input_tempat_lahir', parent=self, pos=wx.Point(192, 328),
              size=wx.Size(200, 25), style=wx.TE_READONLY, value=u'')

        self.tanggalkejadian = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANTANGGALKEJADIAN,
              name=u'tanggalkejadian', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(176, 24), style=wx.TE_READONLY, value=u'')

        self.pilihan_golongan_darah = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANPILIHAN_GOLONGAN_DARAH,
              name=u'pilihan_golongan_darah', parent=self, pos=wx.Point(192,
              408), size=wx.Size(80, 25), style=wx.TE_READONLY, value=u'')

        self.pilihan_agama = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANPILIHAN_AGAMA,
              name=u'pilihan_agama', parent=self, pos=wx.Point(400, 208),
              size=wx.Size(216, 25), style=wx.TE_READONLY, value=u'')

        self.label_kewarganegaraan = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_KEWARGANEGARAAN,
        ...
        self.label_pendidikan_terakhir = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_PENDIDIKAN_TERAKHIR,
              label=u'Pendidikan Terakhir', name=u'label_pendidikan_terakhir',
              parent=self, pos=wx.Point(400, 272), size=wx.Size(184, 17),
              style=0)

        self.pilihan_pendidikan_terakhir = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANPILIHAN_PENDIDIKAN_TERAKHIR,
              name=u'pilihan_pendidikan_terakhir', parent=self,
              pos=wx.Point(400, 288), size=wx.Size(216, 25),
              style=wx.TE_READONLY, value=u'')

        self.label_pendidikan_tempuh = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_PENDIDIKAN_TEMPUH,
        ...
        self.label_shdk = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_SHDK,
        ...
        self.label_nama_ayah = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_NAMA_AYAH,
        ...
        self.label_nama_ibu = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_NAMA_IBU,
        ...
        self.label_resiko_kehamilan = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_RESIKO_KEHAMILAN,
              label=u'Resiko Kehamilan', name=u'label_resiko_kehamilan',
              parent=self, pos=wx.Point(624, 392), size=wx.Size(176, 17),
              style=0)

        self.tombol_tambah_data = wx.Button(id=wxID_KEJADIAN_KEMATIANTOMBOL_TAMBAH_DATA,
        ...
        self.label_data_penduduk = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_DATA_PENDUDUK,
        ...
        self.tglkejadian = wx.DatePickerCtrl(id=wxID_KEJADIAN_KEMATIANTGLKEJADIAN,
        ...
        self.tanggalkematian = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANTANGGALKEJADIAN,
              name=u'tanggalkejadian', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(176, 24), style=wx.TE_READONLY, value=u'')
        ...
        self.tanggal_lahir = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANTANGGAL_LAHIR,
              name=u'tanggal_lahir', parent=self, pos=wx.Point(192, 368),
              size=wx.Size(200, 27), style=0, value=u'')

        self.namapengganti = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANNAMAPENGGANTI,
              name=u'namapengganti', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(200, 27), style=0, value=u'')
    ...
    def OnTombol_tambah_dataButton(self, event):
        ...
        if laporan == '':
        ...
        elif shdk == 'Kepala Keluarga':       
            sql="SELECT * FROM penduduk WHERE no_kk='"+(nokk)+"' AND shdk='Istri'"
            cur.execute(sql)
            hasil = cur.fetchone()
            if hasil:    
                self.namapengganti.SetValue(str(hasil[2]))
                pengganti = str(self.namapengganti.GetValue())
                add_istri="UPDATE penduduk SET shdk='Kepala Keluarga',nama_kep_kel='"+(pengganti)+"' WHERE no_kk='"+(nokk)+"' AND shdk='Istri'"
                cur.execute(add_istri)
                db.commit()
                ...
                db.commit()
                self.pesan = wx.MessageDialog(self,"Yang meninggal Kepala Keluarga Jadi Otomatis Istri Menjadi Kepala Keluarga","Konfirmasi",wx.OK) 
                self.pesan.ShowModal()
                self.awal()
                ...
                cur.execute(add_kejadian)
                db.commit()
                self.pesan = wx.MessageDialog(self,"Yang meninggal Kepala Keluarga Tidak Ada Istri Menjadi Kepala Keluarga","Konfirmasi",wx.OK) 
                self.pesan.ShowModal()
                self.awal()
            ...
            cur.execute(add_kejadian)
            db.commit()
            self.pesan = wx.MessageDialog(self,"Data Telah Tersimpan, Dan Yang Meninggal Bukan Kepala Keluarga","Konfirmasi",wx.OK) 
            self.pesan.ShowModal() 
            self.awal()
