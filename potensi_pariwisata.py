...
[wxID_POTENSI_PARIWISATA, wxID_POTENSI_PARIWISATAEDIT, wxID_POTENSI_PARIWISATAHAPUS, 
 wxID_POTENSI_PARIWISATAINPUT_JUMLAH, wxID_POTENSI_PARIWISATAINPUT_PEMILIK, 
 wxID_POTENSI_PARIWISATAINPUT_TAMBAK, wxID_POTENSI_PARIWISATAKEMBALI, 
 wxID_POTENSI_PARIWISATANO, wxID_POTENSI_PARIWISATARICHTEXTCTRL1, 
 wxID_POTENSI_PARIWISATASTATICTEXT1, wxID_POTENSI_PARIWISATASTATICTEXT2, 
 wxID_POTENSI_PARIWISATASTATICTEXT3, wxID_POTENSI_PARIWISATASTATICTEXT4, 
 wxID_POTENSI_PARIWISATATAMBAH, wxID_POTENSI_PARIWISATATAMBAK, 
...
class potensi_pariwisata(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Frame.__init__(self, id=wxID_POTENSI_PARIWISATA, name=u'potensi_pariwisata',
        ...
        self.tambak = wx.ListCtrl(id=wxID_POTENSI_PARIWISATATAMBAK, name=u'tambak',
        ...
        self.input_tambak = wx.ComboBox(choices=['Wana Wisata', 'Pantai', 'Hotel', 'Losmen'],
              id=wxID_POTENSI_PARIWISATAINPUT_TAMBAK, name=u'input_tambak',
        ...
        self.no = wx.TextCtrl(id=wxID_POTENSI_PARIWISATANO, name=u'no', parent=self,
        ...
        self.tambah = wx.Button(id=wxID_POTENSI_PARIWISATATAMBAH, label=u'Tambah',
