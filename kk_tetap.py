...
[wxID_KK_TETAP, wxID_KK_TETAPBUTTON1, wxID_KK_TETAPDESA, wxID_KK_TETAPDOKUMEN, 
 ...
 wxID_KK_TETAPLABEL_PENDIDIKAN_TERAKHIR, 
...
class kk_tetap(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Dialog.__init__(self, id=wxID_KK_TETAP, name=u'kk_tetap',
              parent=prnt, pos=wx.Point(406, 79), size=wx.Size(888, 639),
              style=wx.TAB_TRAVERSAL, title=u'Tambah Kartu Keluarga Tetap')
