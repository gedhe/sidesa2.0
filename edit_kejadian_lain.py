...
def create(parent):
    return edit_kejadian_lain(parent)

[wxID_EDIT_KEJADIAN_LAIN, wxID_EDIT_KEJADIAN_LAINCARI_KK, 
 wxID_EDIT_KEJADIAN_LAINDOKUMEN, wxID_EDIT_KEJADIAN_LAININPUTNO, 
 wxID_EDIT_KEJADIAN_LAININPUT_ALAMAT, wxID_EDIT_KEJADIAN_LAININPUT_AYAH, 
 wxID_EDIT_KEJADIAN_LAININPUT_DUSUN, wxID_EDIT_KEJADIAN_LAININPUT_IBU, 
 wxID_EDIT_KEJADIAN_LAININPUT_NAMA, wxID_EDIT_KEJADIAN_LAININPUT_NIK, 
 wxID_EDIT_KEJADIAN_LAININPUT_NO, wxID_EDIT_KEJADIAN_LAININPUT_NO_KK, 
 wxID_EDIT_KEJADIAN_LAININPUT_RT, wxID_EDIT_KEJADIAN_LAININPUT_RW, 
 wxID_EDIT_KEJADIAN_LAININPUT_TEMPAT_LAHIR, 
 wxID_EDIT_KEJADIAN_LAINISIPENDUDUK, wxID_EDIT_KEJADIAN_LAINKEMBALI, 
 wxID_EDIT_KEJADIAN_LAINKETERANGAN, wxID_EDIT_KEJADIAN_LAINLABEL_AGAMA, 
 wxID_EDIT_KEJADIAN_LAINLABEL_ALAMAT, 
 wxID_EDIT_KEJADIAN_LAINLABEL_DATA_PENDUDUK, 
 wxID_EDIT_KEJADIAN_LAINLABEL_DIFABELITAS, wxID_EDIT_KEJADIAN_LAINLABEL_DUSUN, 
 wxID_EDIT_KEJADIAN_LAINLABEL_GOLONGAN_DARAH, 
 wxID_EDIT_KEJADIAN_LAINLABEL_JENIS_KELAMIN, 
 wxID_EDIT_KEJADIAN_LAINLABEL_KEWARGANEGARAAN, 
 wxID_EDIT_KEJADIAN_LAINLABEL_KONTRASEPSI, 
 wxID_EDIT_KEJADIAN_LAINLABEL_NAMA_AYAH, 
 wxID_EDIT_KEJADIAN_LAINLABEL_NAMA_IBU, 
 wxID_EDIT_KEJADIAN_LAINLABEL_NAMA_LENGKAP, 
 wxID_EDIT_KEJADIAN_LAINLABEL_NOMOR_KK, 
 wxID_EDIT_KEJADIAN_LAINLABEL_PEKERJAAN, 
 wxID_EDIT_KEJADIAN_LAINLABEL_PEKERJAAN_LAINNYA, 
 wxID_EDIT_KEJADIAN_LAINLABEL_PENDIDIKAN_TEMPUH, 
 wxID_EDIT_KEJADIAN_LAINLABEL_PENDIDIKAN_TERAKHIR, 
 wxID_EDIT_KEJADIAN_LAINLABEL_RESIKO_KEHAMILAN, 
 wxID_EDIT_KEJADIAN_LAINLABEL_SHDK, 
 wxID_EDIT_KEJADIAN_LAINLABEL_STATUS_KEPENDUDUKAN, 
 wxID_EDIT_KEJADIAN_LAINLABEL_STATUS_PERKAWINAN, 
 wxID_EDIT_KEJADIAN_LAINLABEL_STATUS_TINGGAL, 
 wxID_EDIT_KEJADIAN_LAINLABEL_TANGGAL_LAHIR, 
 wxID_EDIT_KEJADIAN_LAINLABEL_TEMPAT_LAHIR, wxID_EDIT_KEJADIAN_LAINLAPORAN, 
 wxID_EDIT_KEJADIAN_LAINLEBEL_NIK, wxID_EDIT_KEJADIAN_LAINNAMA_KK, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_AGAMA, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_DIFABELITAS, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_GOLONGAN_DARAH, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_JENIS_KELAMIN, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_KEHAMILAN, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_KONTRASEPSI, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_PEKERJAAN, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_PEKERJAAN_LAINNYA, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_PENDIDIKAN_DITEMPUH, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_PENDIDIKAN_TERAKHIR, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_SHDK, wxID_EDIT_KEJADIAN_LAINPILIHAN_STATUS, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_STATUS_KEPENDUDUKAN, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_STATUS_TINGGAL, 
 wxID_EDIT_KEJADIAN_LAINPILIHAN_WARGANEGARA, 
 wxID_EDIT_KEJADIAN_LAINSIMPANGAMBAR, wxID_EDIT_KEJADIAN_LAINSTATICTEXT1, 
 wxID_EDIT_KEJADIAN_LAINSTATICTEXT2, wxID_EDIT_KEJADIAN_LAINSTATICTEXT3, 
 wxID_EDIT_KEJADIAN_LAINSTATICTEXT4, wxID_EDIT_KEJADIAN_LAINSTATICTEXT5, 
 wxID_EDIT_KEJADIAN_LAINSTATICTEXT6, wxID_EDIT_KEJADIAN_LAINSTATICTEXT7, 
 wxID_EDIT_KEJADIAN_LAINTANGGALKEJADIAN, wxID_EDIT_KEJADIAN_LAINTANGGAL_LAHIR, 
 wxID_EDIT_KEJADIAN_LAINTGLKEJADIAN, wxID_EDIT_KEJADIAN_LAINTOMBOL_CARI, 
 wxID_EDIT_KEJADIAN_LAINTOMBOL_TAMBAH_DATA, 
] = [wx.NewId() for _init_ctrls in range(73)]

class edit_kejadian_lain(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.label_pendidikan_terakhir = wx.StaticText(id=wxID_EDIT_KEJADIAN_LAINLABEL_PENDIDIKAN_TERAKHIR,
              label=u'Pendidikan Terakhir', name=u'label_pendidikan_terakhir',
              parent=self, pos=wx.Point(400, 272), size=wx.Size(184, 17),
              style=0)

        self.pilihan_pendidikan_terakhir = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_LAINPILIHAN_PENDIDIKAN_TERAKHIR,
              name=u'pilihan_pendidikan_terakhir', parent=self,
              pos=wx.Point(400, 288), size=wx.Size(216, 25),
              style=wx.TE_READONLY, value=u'')

        self.label_pendidikan_tempuh = wx.StaticText(id=wxID_EDIT_KEJADIAN_LAINLABEL_PENDIDIKAN_TEMPUH,
        ...
        self.tombol_tambah_data.Bind(wx.EVT_BUTTON,
              ...
              id=wxID_EDIT_KEJADIAN_LAINTOMBOL_TAMBAH_DATA)

        self.kembali = wx.Button(id=wxID_EDIT_KEJADIAN_LAINKEMBALI,
        ...
        self.kembali.Bind(wx.EVT_BUTTON, self.OnKembaliButton,
              id=wxID_EDIT_KEJADIAN_LAINKEMBALI)

        self.dokumen = wx.StaticText(id=wxID_EDIT_KEJADIAN_LAINDOKUMEN,
              label=u'Catatan Kejadian Penduduk Lainnya', name=u'dokumen',
              parent=self, pos=wx.Point(16, 440), size=wx.Size(304, 17),
              style=0)

        self.label_data_penduduk = wx.StaticText(id=wxID_EDIT_KEJADIAN_LAINLABEL_DATA_PENDUDUK,
              label=u'FORM DATA PENDUDUK', name=u'label_data_penduduk',
              parent=self, pos=wx.Point(336, 0), size=wx.Size(216, 17),
              style=0)

        self.isipenduduk = wx.ListCtrl(id=wxID_EDIT_KEJADIAN_LAINISIPENDUDUK,
        ...
        self.isipenduduk.Bind(wx.EVT_LIST_ITEM_SELECTED,
              ...
              id=wxID_EDIT_KEJADIAN_LAINISIPENDUDUK)

        self.staticText1 = wx.StaticText(id=wxID_EDIT_KEJADIAN_LAINSTATICTEXT1,
              label=u'Nama Lengkap', name='staticText1', parent=self,
              pos=wx.Point(400, 128), size=wx.Size(145, 17), style=0)

        self.cari_kk = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_LAINCARI_KK,
              name=u'cari_kk', parent=self, pos=wx.Point(552, 128),
              size=wx.Size(224, 24), style=0, value='')

        self.tombol_cari = wx.Button(id=wxID_EDIT_KEJADIAN_LAINTOMBOL_CARI,
        ...
        self.simpangambar = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_LAINSIMPANGAMBAR,
              name=u'simpangambar', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(152, 24), style=0, value=u'')

        self.tanggal_lahir = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_LAINTANGGAL_LAHIR,
              name=u'tanggal_lahir', parent=self, pos=wx.Point(192, 368),
              size=wx.Size(200, 27), style=0, value=u'')

        self.inputno = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_LAININPUTNO,
    ...
    def IsiList(self):    
        ...
        sql = "SELECT * FROM penduduk WHERE kejadianlain='Ya' AND kematian='Tidak'"
        cur.execute(sql) 
        hasil = cur.fetchall() 
    ...
    def Isi_Object2(self) :   
        carikk=str(self.cari_kk.GetValue())
        sql="SELECT * FROM peristiwalain WHERE nomornik='%s'"%(carikk)
        cur.execute(sql)
        ada = cur.fetchone() 
        if ada:
            self.laporan.SetValue(str(ada[4]))
            self.keterangan.SetValue(str(ada[3]))
            self.tglkejadian.SetValue(str(ada[2]))
