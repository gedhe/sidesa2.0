#Boa:Dialog:edit_kejadian_pindah
...
def create(parent):
    return edit_kejadian_pindah(parent)

[wxID_EDIT_KEJADIAN_PINDAH, wxID_EDIT_KEJADIAN_PINDAHCARI_KK, 
 wxID_EDIT_KEJADIAN_PINDAHDOKUMEN, wxID_EDIT_KEJADIAN_PINDAHINPUTNO, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_ALAMAT, wxID_EDIT_KEJADIAN_PINDAHINPUT_AYAH, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_DUSUN, wxID_EDIT_KEJADIAN_PINDAHINPUT_IBU, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_NAMA, wxID_EDIT_KEJADIAN_PINDAHINPUT_NIK, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_NO, wxID_EDIT_KEJADIAN_PINDAHINPUT_NO_KK, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_RT, wxID_EDIT_KEJADIAN_PINDAHINPUT_RW, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_TEMPAT_LAHIR, 
 wxID_EDIT_KEJADIAN_PINDAHISIPENDUDUK, wxID_EDIT_KEJADIAN_PINDAHKEMBALI, 
 wxID_EDIT_KEJADIAN_PINDAHKETERANGAN, wxID_EDIT_KEJADIAN_PINDAHLABEL_AGAMA, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_ALAMAT, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_DATA_PENDUDUK, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_DIFABELITAS, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_DUSUN, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_GOLONGAN_DARAH, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_JENIS_KELAMIN, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_KEWARGANEGARAAN, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_KONTRASEPSI, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_NAMA_AYAH, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_NAMA_IBU, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_NAMA_LENGKAP, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_NOMOR_KK, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_PEKERJAAN, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_PEKERJAAN_LAINNYA, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_PENDIDIKAN_TEMPUH, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_PENDIDIKAN_TERAKHIR, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_RESIKO_KEHAMILAN, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_SHDK, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_STATUS_KEPENDUDUKAN, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_STATUS_PERKAWINAN, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_STATUS_TINGGAL, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_TANGGAL_LAHIR, 
 wxID_EDIT_KEJADIAN_PINDAHLABEL_TEMPAT_LAHIR, 
 wxID_EDIT_KEJADIAN_PINDAHLAPORAN, wxID_EDIT_KEJADIAN_PINDAHLEBEL_NIK, 
 wxID_EDIT_KEJADIAN_PINDAHNAMA_KK, wxID_EDIT_KEJADIAN_PINDAHPILIHAN_AGAMA, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_DIFABELITAS, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_GOLONGAN_DARAH, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_JENIS_KELAMIN, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_KEHAMILAN, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_KONTRASEPSI, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_PEKERJAAN, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_PEKERJAAN_LAINNYA, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_PENDIDIKAN_DITEMPUH, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_PENDIDIKAN_TERAKHIR, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_SHDK, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_STATUS, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_STATUS_KEPENDUDUKAN, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_STATUS_TINGGAL, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_WARGANEGARA, 
 wxID_EDIT_KEJADIAN_PINDAHSIMPANGAMBAR, wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT1, 
 wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT2, wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT3, 
 wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT4, wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT5, 
 wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT6, wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT7, 
 wxID_EDIT_KEJADIAN_PINDAHTANGGALKEJADIAN, 
 wxID_EDIT_KEJADIAN_PINDAHTANGGALKEMATIAN, 
 wxID_EDIT_KEJADIAN_PINDAHTANGGAL_LAHIR, wxID_EDIT_KEJADIAN_PINDAHTGLKEJADIAN, 
 wxID_EDIT_KEJADIAN_PINDAHTOMBOL_CARI, 
 wxID_EDIT_KEJADIAN_PINDAHTOMBOL_TAMBAH_DATA, 
] = [wx.NewId() for _init_ctrls in range(74)]

class edit_kejadian_pindah(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.label_pendidikan_terakhir = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHLABEL_PENDIDIKAN_TERAKHIR,
              label=u'Pendidikan Terakhir', name=u'label_pendidikan_terakhir',
              parent=self, pos=wx.Point(400, 272), size=wx.Size(184, 17),
              style=0)

        self.pilihan_pendidikan_terakhir = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHPILIHAN_PENDIDIKAN_TERAKHIR,
              name=u'pilihan_pendidikan_terakhir', parent=self,
              pos=wx.Point(400, 288), size=wx.Size(216, 25),
              style=wx.TE_READONLY, value=u'')

        self.label_pendidikan_tempuh = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHLABEL_PENDIDIKAN_TEMPUH,
        ...
        self.tombol_tambah_data.Bind(wx.EVT_BUTTON,
              ...
              id=wxID_EDIT_KEJADIAN_PINDAHTOMBOL_TAMBAH_DATA)

        self.kembali = wx.Button(id=wxID_EDIT_KEJADIAN_PINDAHKEMBALI,
        ...
        self.kembali.Bind(wx.EVT_BUTTON, self.OnKembaliButton,
              id=wxID_EDIT_KEJADIAN_PINDAHKEMBALI)

        self.dokumen = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHDOKUMEN,
              label=u'Catatan Pindah Penduduk', name=u'dokumen', parent=self,
              pos=wx.Point(16, 440), size=wx.Size(304, 17), style=0)

        self.label_data_penduduk = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHLABEL_DATA_PENDUDUK,
              label=u'FORM DATA PENDUDUK', name=u'label_data_penduduk',
              parent=self, pos=wx.Point(336, 0), size=wx.Size(216, 17),
              style=0)

        self.isipenduduk = wx.ListCtrl(id=wxID_EDIT_KEJADIAN_PINDAHISIPENDUDUK,
        ...
        self.isipenduduk.Bind(wx.EVT_LIST_ITEM_SELECTED,
              ...
              id=wxID_EDIT_KEJADIAN_PINDAHISIPENDUDUK)

        self.staticText1 = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT1,
              label=u'Nama Lengkap', name='staticText1', parent=self,
              pos=wx.Point(400, 128), size=wx.Size(145, 17), style=0)

        self.cari_kk = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHCARI_KK,
              name=u'cari_kk', parent=self, pos=wx.Point(552, 128),
              size=wx.Size(224, 24), style=0, value='')

        self.tombol_cari = wx.Button(id=wxID_EDIT_KEJADIAN_PINDAHTOMBOL_CARI,
        ...
        self.tombol_cari.Bind(wx.EVT_BUTTON, self.OnTombol_cariButton,
              id=wxID_EDIT_KEJADIAN_PINDAHTOMBOL_CARI)

        self.input_no = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHINPUT_NO,
              name=u'input_no', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(56, 27), style=wx.TE_READONLY, value=u'')

        self.staticText2 = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT2,
              label=u'RT', name='staticText2', parent=self, pos=wx.Point(760,
              152), size=wx.Size(24, 16), style=0)

        self.staticText3 = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT3,
              label=u'RW', name='staticText3', parent=self, pos=wx.Point(824,
              152), size=wx.Size(19, 17), style=0)

        self.staticText4 = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT4,
              label=u'Sebab Pindah', name='staticText4', parent=self,
              pos=wx.Point(16, 504), size=wx.Size(118, 17), style=0)

        self.staticText5 = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT5,
              label=u'Alamat', name='staticText5', parent=self,
              pos=wx.Point(336, 504), size=wx.Size(74, 17), style=0)

        self.staticText6 = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT6,
              label=u'Tanggal Pindah', name='staticText6', parent=self,
              pos=wx.Point(16, 464), size=wx.Size(106, 17), style=0)

        self.tglkejadian = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHTGLKEJADIAN,
              name='tglkejadian', parent=self, pos=wx.Point(136, 464),
              size=wx.Size(192, 26), style=0)

        self.nama_kk = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHNAMA_KK,
              name=u'nama_kk', parent=self, pos=wx.Point(8, 208),
              size=wx.Size(176, 24), style=wx.TE_READONLY, value=u'')

        self.staticText7 = wx.StaticText(id=wxID_EDIT_KEJADIAN_PINDAHSTATICTEXT7,
              label=u'Nama Kepala Keluarga', name='staticText7', parent=self,
              pos=wx.Point(8, 192), size=wx.Size(135, 17), style=0)

        self.tanggalkematian = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHTANGGALKEJADIAN,
              name=u'tanggalkejadian', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(176, 24), style=wx.TE_READONLY, value=u'')

        self.simpangambar = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHSIMPANGAMBAR,
              name=u'simpangambar', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(152, 24), style=0, value=u'')

        self.tanggal_lahir = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHTANGGAL_LAHIR,
              name=u'tanggal_lahir', parent=self, pos=wx.Point(192, 368),
              size=wx.Size(200, 27), style=0, value=u'')

        self.inputno = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHINPUTNO,
    ...
    def IsiList(self):    
        ...
        sql = "SELECT * FROM penduduk WHERE pindah='Ya' AND kematian='Tidak'"
        cur.execute(sql) 
        hasil = cur.fetchall() 
    ...
    def Isi_Object(self) : 
        ...
        sql="SELECT * FROM penduduk WHERE kematian='Tidak' AND nik='%s'"%(carikk)
        cur.execute(sql)
        hasil = cur.fetchone()  
        if hasil : 
