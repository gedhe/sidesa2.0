...
def create(parent):
    return kejadian_pindah(parent)

[wxID_KEJADIAN_PINDAH, wxID_KEJADIAN_PINDAHCARI_KK, 
 wxID_KEJADIAN_PINDAHDOKUMEN, wxID_KEJADIAN_PINDAHINPUT_ALAMAT, 
 wxID_KEJADIAN_PINDAHINPUT_AYAH, wxID_KEJADIAN_PINDAHINPUT_DUSUN, 
 wxID_KEJADIAN_PINDAHINPUT_IBU, wxID_KEJADIAN_PINDAHINPUT_NAMA, 
 wxID_KEJADIAN_PINDAHINPUT_NIK, wxID_KEJADIAN_PINDAHINPUT_NO, 
 wxID_KEJADIAN_PINDAHINPUT_NO_KK, wxID_KEJADIAN_PINDAHINPUT_RT, 
 wxID_KEJADIAN_PINDAHINPUT_RW, wxID_KEJADIAN_PINDAHINPUT_TEMPAT_LAHIR, 
 wxID_KEJADIAN_PINDAHISIPENDUDUK, wxID_KEJADIAN_PINDAHKEMBALI, 
 wxID_KEJADIAN_PINDAHKETERANGAN, wxID_KEJADIAN_PINDAHLABEL_AGAMA, 
 wxID_KEJADIAN_PINDAHLABEL_ALAMAT, wxID_KEJADIAN_PINDAHLABEL_DATA_PENDUDUK, 
 wxID_KEJADIAN_PINDAHLABEL_DIFABELITAS, wxID_KEJADIAN_PINDAHLABEL_DUSUN, 
 wxID_KEJADIAN_PINDAHLABEL_GOLONGAN_DARAH, 
 wxID_KEJADIAN_PINDAHLABEL_JENIS_KELAMIN, 
 wxID_KEJADIAN_PINDAHLABEL_KEWARGANEGARAAN, 
 wxID_KEJADIAN_PINDAHLABEL_KONTRASEPSI, wxID_KEJADIAN_PINDAHLABEL_NAMA_AYAH, 
 wxID_KEJADIAN_PINDAHLABEL_NAMA_IBU, wxID_KEJADIAN_PINDAHLABEL_NAMA_LENGKAP, 
 wxID_KEJADIAN_PINDAHLABEL_NOMOR_KK, wxID_KEJADIAN_PINDAHLABEL_PEKERJAAN, 
 wxID_KEJADIAN_PINDAHLABEL_PEKERJAAN_LAINNYA, 
 wxID_KEJADIAN_PINDAHLABEL_PENDIDIKAN_TEMPUH, 
 wxID_KEJADIAN_PINDAHLABEL_PENDIDIKAN_TERAKHIR, 
 wxID_KEJADIAN_PINDAHLABEL_RESIKO_KEHAMILAN, wxID_KEJADIAN_PINDAHLABEL_SHDK, 
 wxID_KEJADIAN_PINDAHLABEL_STATUS_KEPENDUDUKAN, 
 wxID_KEJADIAN_PINDAHLABEL_STATUS_PERKAWINAN, 
 wxID_KEJADIAN_PINDAHLABEL_STATUS_TINGGAL, 
 wxID_KEJADIAN_PINDAHLABEL_TANGGAL_LAHIR, 
 wxID_KEJADIAN_PINDAHLABEL_TEMPAT_LAHIR, wxID_KEJADIAN_PINDAHLAPORAN, 
 wxID_KEJADIAN_PINDAHLEBEL_NIK, wxID_KEJADIAN_PINDAHNAMA_KK, 
 wxID_KEJADIAN_PINDAHPILIHAN_AGAMA, wxID_KEJADIAN_PINDAHPILIHAN_DIFABELITAS, 
 wxID_KEJADIAN_PINDAHPILIHAN_GOLONGAN_DARAH, 
 wxID_KEJADIAN_PINDAHPILIHAN_JENIS_KELAMIN, 
 wxID_KEJADIAN_PINDAHPILIHAN_KEHAMILAN, 
 wxID_KEJADIAN_PINDAHPILIHAN_KONTRASEPSI, 
 wxID_KEJADIAN_PINDAHPILIHAN_PEKERJAAN, 
 wxID_KEJADIAN_PINDAHPILIHAN_PEKERJAAN_LAINNYA, 
 wxID_KEJADIAN_PINDAHPILIHAN_PENDIDIKAN_DITEMPUH, 
 wxID_KEJADIAN_PINDAHPILIHAN_PENDIDIKAN_TERAKHIR, 
 wxID_KEJADIAN_PINDAHPILIHAN_SHDK, wxID_KEJADIAN_PINDAHPILIHAN_STATUS, 
 wxID_KEJADIAN_PINDAHPILIHAN_STATUS_KEPENDUDUKAN, 
 wxID_KEJADIAN_PINDAHPILIHAN_STATUS_TINGGAL, 
 wxID_KEJADIAN_PINDAHPILIHAN_WARGANEGARA, wxID_KEJADIAN_PINDAHSIMPANGAMBAR, 
 wxID_KEJADIAN_PINDAHSTATICTEXT1, wxID_KEJADIAN_PINDAHSTATICTEXT2, 
 wxID_KEJADIAN_PINDAHSTATICTEXT3, wxID_KEJADIAN_PINDAHSTATICTEXT4, 
 wxID_KEJADIAN_PINDAHSTATICTEXT5, wxID_KEJADIAN_PINDAHSTATICTEXT6, 
 wxID_KEJADIAN_PINDAHSTATICTEXT7, wxID_KEJADIAN_PINDAHTANGGALKEJADIAN, 
 wxID_KEJADIAN_PINDAHTANGGALKEMATIAN, wxID_KEJADIAN_PINDAHTANGGAL_LAHIR, 
 wxID_KEJADIAN_PINDAHTGLKEJADIAN, wxID_KEJADIAN_PINDAHTOMBOL_CARI, 
 wxID_KEJADIAN_PINDAHTOMBOL_TAMBAH_DATA, 
] = [wx.NewId() for _init_ctrls in range(73)]

class kejadian_pindah(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.label_pendidikan_terakhir = wx.StaticText(id=wxID_KEJADIAN_PINDAHLABEL_PENDIDIKAN_TERAKHIR,
              label=u'Pendidikan Terakhir', name=u'label_pendidikan_terakhir',
              parent=self, pos=wx.Point(400, 272), size=wx.Size(184, 17),
              style=0)

        self.pilihan_pendidikan_terakhir = wx.TextCtrl(id=wxID_KEJADIAN_PINDAHPILIHAN_PENDIDIKAN_TERAKHIR,
              name=u'pilihan_pendidikan_terakhir', parent=self,
              pos=wx.Point(400, 288), size=wx.Size(216, 25),
              style=wx.TE_READONLY, value=u'')

        self.label_pendidikan_tempuh = wx.StaticText(id=wxID_KEJADIAN_PINDAHLABEL_PENDIDIKAN_TEMPUH,
        ...
        self.tombol_tambah_data.Bind(wx.EVT_BUTTON,
              ...
              id=wxID_KEJADIAN_PINDAHTOMBOL_TAMBAH_DATA)

        self.kembali = wx.Button(id=wxID_KEJADIAN_PINDAHKEMBALI,
        ...
        self.kembali.Bind(wx.EVT_BUTTON, self.OnKembaliButton,
              id=wxID_KEJADIAN_PINDAHKEMBALI)

        self.dokumen = wx.StaticText(id=wxID_KEJADIAN_PINDAHDOKUMEN,
              label=u'Catatan Pindah Penduduk', name=u'dokumen', parent=self,
              pos=wx.Point(16, 440), size=wx.Size(304, 17), style=0)

        self.label_data_penduduk = wx.StaticText(id=wxID_KEJADIAN_PINDAHLABEL_DATA_PENDUDUK,
              label=u'FORM DATA PENDUDUK', name=u'label_data_penduduk',
              parent=self, pos=wx.Point(336, 0), size=wx.Size(216, 17),
              style=0)

        self.isipenduduk = wx.ListCtrl(id=wxID_KEJADIAN_PINDAHISIPENDUDUK,
        ...
        self.isipenduduk.Bind(wx.EVT_LIST_ITEM_SELECTED,
              ...
              id=wxID_KEJADIAN_PINDAHISIPENDUDUK)

        self.staticText1 = wx.StaticText(id=wxID_KEJADIAN_PINDAHSTATICTEXT1,
              label=u'Nama Lengkap', name='staticText1', parent=self,
              pos=wx.Point(400, 128), size=wx.Size(145, 17), style=0)

        self.cari_kk = wx.TextCtrl(id=wxID_KEJADIAN_PINDAHCARI_KK,
              name=u'cari_kk', parent=self, pos=wx.Point(552, 128),
              size=wx.Size(224, 24), style=0, value='')

        self.tombol_cari = wx.Button(id=wxID_KEJADIAN_PINDAHTOMBOL_CARI,
        ...
        self.nama_kk = wx.TextCtrl(id=wxID_KEJADIAN_PINDAHNAMA_KK,
              name=u'nama_kk', parent=self, pos=wx.Point(8, 208),
              size=wx.Size(176, 24), style=wx.TE_READONLY, value=u'')

        self.staticText7 = wx.StaticText(id=wxID_KEJADIAN_PINDAHSTATICTEXT7,
              label=u'Nama Kepala Keluarga', name='staticText7', parent=self,
              pos=wx.Point(8, 192), size=wx.Size(135, 17), style=0)

        self.tanggalkematian = wx.TextCtrl(id=wxID_KEJADIAN_PINDAHTANGGALKEJADIAN,
              name=u'tanggalkejadian', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(176, 24), style=wx.TE_READONLY, value=u'')

        self.simpangambar = wx.TextCtrl(id=wxID_KEJADIAN_PINDAHSIMPANGAMBAR,
              name=u'simpangambar', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(152, 24), style=0, value=u'')

        self.tanggal_lahir = wx.TextCtrl(id=wxID_KEJADIAN_PINDAHTANGGAL_LAHIR,
