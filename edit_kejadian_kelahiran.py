#Boa:Frame:edit_kejadian_kelahiran
...
def create(parent):
    return edit_kejadian_kelahiran(parent)

[wxID_EDIT_KEJADIAN_KELAHIRAN, wxID_EDIT_KEJADIAN_KELAHIRANBUTTON1, 
 wxID_EDIT_KEJADIAN_KELAHIRANCARI_KK, wxID_EDIT_KEJADIAN_KELAHIRANDESA, 
 wxID_EDIT_KEJADIAN_KELAHIRANDOKUMEN, wxID_EDIT_KEJADIAN_KELAHIRANGAMBAR, 
 wxID_EDIT_KEJADIAN_KELAHIRANINPUT_ALAMAT, 
 wxID_EDIT_KEJADIAN_KELAHIRANINPUT_AYAH, 
 wxID_EDIT_KEJADIAN_KELAHIRANINPUT_DUSUN, 
 wxID_EDIT_KEJADIAN_KELAHIRANINPUT_IBU, 
 wxID_EDIT_KEJADIAN_KELAHIRANINPUT_NAMA, 
 wxID_EDIT_KEJADIAN_KELAHIRANINPUT_NIK, wxID_EDIT_KEJADIAN_KELAHIRANINPUT_NO, 
 wxID_EDIT_KEJADIAN_KELAHIRANINPUT_NO_KK, 
 wxID_EDIT_KEJADIAN_KELAHIRANINPUT_RT, wxID_EDIT_KEJADIAN_KELAHIRANINPUT_RW, 
 wxID_EDIT_KEJADIAN_KELAHIRANINPUT_TEMPAT_LAHIR, 
 wxID_EDIT_KEJADIAN_KELAHIRANISIPENDUDUK, 
 wxID_EDIT_KEJADIAN_KELAHIRANKABUPATEN, wxID_EDIT_KEJADIAN_KELAHIRANKECAMATAN, 
 wxID_EDIT_KEJADIAN_KELAHIRANKEMBALI, wxID_EDIT_KEJADIAN_KELAHIRANKET, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_AGAMA, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_ALAMAT, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_DATA_PENDUDUK, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_DIFABELITAS, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_DUSUN, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_GOLONGAN_DARAH, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_JENIS_KELAMIN, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_KEWARGANEGARAAN, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_KONTRASEPSI, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_NAMA_AYAH, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_NAMA_IBU, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_NAMA_LENGKAP, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_NOMOR_KK, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_PEKERJAAN, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_PEKERJAAN_LAINNYA, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_PENDIDIKAN_TEMPUH, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_PENDIDIKAN_TERAKHIR, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_RESIKO_KEHAMILAN, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_SHDK, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_STATUS_KEPENDUDUKAN, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_STATUS_PERKAWINAN, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_STATUS_TINGGAL, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_TANGGAL_LAHIR, 
 wxID_EDIT_KEJADIAN_KELAHIRANLABEL_TEMPAT_LAHIR, 
 wxID_EDIT_KEJADIAN_KELAHIRANLEBEL_NIK, wxID_EDIT_KEJADIAN_KELAHIRANNAMA_KK, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_AGAMA, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_DIFABELITAS, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_GOLONGAN_DARAH, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_JENIS_KELAMIN, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_KEHAMILAN, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_KONTRASEPSI, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_PEKERJAAN, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_PEKERJAAN_LAINNYA, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_PENDIDIKAN_DITEMPUH, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_PENDIDIKAN_TERAKHIR, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_SHDK, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_STATUS, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_STATUS_KEPENDUDUKAN, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_STATUS_TINGGAL, 
 wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_WARGANEGARA, 
 wxID_EDIT_KEJADIAN_KELAHIRANPROPINSI, 
 wxID_EDIT_KEJADIAN_KELAHIRANSIMPANGAMBAR, 
 wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT1, 
 wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT2, 
 wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT3, 
 wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT4, 
 wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT5, 
 wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT6, 
 wxID_EDIT_KEJADIAN_KELAHIRANTANGGAL_LAHIR, 
 wxID_EDIT_KEJADIAN_KELAHIRANTGLLAHIR, 
 wxID_EDIT_KEJADIAN_KELAHIRANTOMBOL_CARI, 
 wxID_EDIT_KEJADIAN_KELAHIRANTOMBOL_TAMBAH_DATA, 
 wxID_EDIT_KEJADIAN_KELAHIRANYANG_LAPOR, 
] = [wx.NewId() for _init_ctrls in range(76)]

class edit_kejadian_kelahiran(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Dialog.__init__(self, id=wxID_EDIT_KEJADIAN_KELAHIRAN,
              name=u'edit_kejadian_kelahiran', parent=prnt, pos=wx.Point(406,
              79), size=wx.Size(888, 639), style=wx.FRAME_NO_TASKBAR,
              title=u'Edit Kejadian Kelahiran')
        self.SetClientSize(wx.Size(888, 639))
        self.Center(wx.BOTH)

        self.label_nomor_kk = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_NOMOR_KK,
              label=u'Nomor KK', name=u'label_nomor_kk', parent=self,
              pos=wx.Point(8, 152), size=wx.Size(168, 17), style=0)

        self.label_alamat = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_ALAMAT,
              label=u'Alamat', name=u'label_alamat', parent=self,
              pos=wx.Point(256, 152), size=wx.Size(47, 17), style=0)

        self.label_dusun = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_DUSUN,
              label=u'Dusun', name=u'label_dusun', parent=self,
              pos=wx.Point(552, 152), size=wx.Size(144, 17), style=0)

        self.lebel_nik = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLEBEL_NIK,
              label=u'N I K *', name=u'lebel_nik', parent=self,
              pos=wx.Point(192, 192), size=wx.Size(40, 17), style=0)

        self.label_tempat_lahir = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_TEMPAT_LAHIR,
              label=u'Tempat Lahir Anak', name=u'label_tempat_lahir',
              parent=self, pos=wx.Point(192, 312), size=wx.Size(176, 17),
              style=0)

        self.label_tanggal_lahir = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_TANGGAL_LAHIR,
              label=u'Tanggal Lahir Anak', name=u'label_tanggal_lahir',
              parent=self, pos=wx.Point(192, 352), size=wx.Size(152, 17),
              style=0)

        self.label_golongan_darah = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_GOLONGAN_DARAH,
              label=u'Golongan Darah', name=u'label_golongan_darah',
              parent=self, pos=wx.Point(192, 392), size=wx.Size(200, 17),
              style=0)

        self.label_nama_lengkap = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_NAMA_LENGKAP,
              label=u'Nama Anak Yang Lahir', name=u'label_nama_lengkap',
              parent=self, pos=wx.Point(192, 232), size=wx.Size(192, 17),
              style=0)

        self.label_jenis_kelamin = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_JENIS_KELAMIN,
              label=u'Jenis Kelamin Anak', name=u'label_jenis_kelamin',
              parent=self, pos=wx.Point(192, 272), size=wx.Size(152, 17),
              style=0)

        self.label_agama = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_AGAMA,
              label=u'Agama', name=u'label_agama', parent=self,
              pos=wx.Point(400, 192), size=wx.Size(120, 17), style=0)

        self.input_no_kk = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANINPUT_NO_KK,
              name=u'input_no_kk', parent=self, pos=wx.Point(8, 168),
              size=wx.Size(240, 25), style=wx.TE_READONLY, value=u'')

        self.input_alamat = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANINPUT_ALAMAT,
              name=u'input_alamat', parent=self, pos=wx.Point(256, 168),
              size=wx.Size(288, 25), style=wx.TE_READONLY, value=u'')

        self.input_dusun = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANINPUT_DUSUN,
              name=u'input_dusun', parent=self, pos=wx.Point(552, 168),
              size=wx.Size(192, 25), style=wx.TE_READONLY, value=u'')

        self.input_rt = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANINPUT_RT,
              name=u'input_rt', parent=self, pos=wx.Point(752, 168),
              size=wx.Size(56, 27), style=0, value=u'')

        self.input_rw = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANINPUT_RW,
              name=u'input_rw', parent=self, pos=wx.Point(816, 168),
              size=wx.Size(56, 27), style=0, value=u'')

        self.input_nik = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANINPUT_NIK,
              name=u'input_nik', parent=self, pos=wx.Point(192, 208),
              size=wx.Size(200, 25), style=0, value=u'')

        self.input_nama = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANINPUT_NAMA,
              name=u'input_nama', parent=self, pos=wx.Point(192, 248),
              size=wx.Size(200, 25), style=0, value=u'')

        self.pilihan_jenis_kelamin = wx.ComboBox(choices=['Laki-laki',
              'Perempuan'],
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_JENIS_KELAMIN,
              name=u'pilihan_jenis_kelamin', parent=self, pos=wx.Point(192,
              288), size=wx.Size(200, 27), style=0)

        self.input_tempat_lahir = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANINPUT_TEMPAT_LAHIR,
              name=u'input_tempat_lahir', parent=self, pos=wx.Point(192, 328),
              size=wx.Size(200, 25), style=0, value=u'')

        self.tanggal_lahir = wx.DatePickerCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANTANGGAL_LAHIR,
        ...
        self.pilihan_golongan_darah = wx.ComboBox(choices=['A', 'AB', 'B', 'O',
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_GOLONGAN_DARAH,
        ...
        self.pilihan_agama = wx.ComboBox(choices=['Islam', 'Kristen Protestan',
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_AGAMA,
              name=u'pilihan_agama', parent=self, pos=wx.Point(400, 208),
              size=wx.Size(216, 25), style=0)

        self.label_kewarganegaraan = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_KEWARGANEGARAAN,
        ...
        self.pilihan_warganegara = wx.ComboBox(choices=['WNI', 'WNA'],
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_WARGANEGARA,
              name=u'pilihan_warganegara', parent=self, pos=wx.Point(400, 248),
              size=wx.Size(216, 25), style=0)

        self.label_pendidikan_terakhir = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_PENDIDIKAN_TERAKHIR,
        ...
        self.pilihan_pendidikan_terakhir = wx.ComboBox(choices=['Tidak / Belum Sekolah',
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_PENDIDIKAN_TERAKHIR,
              name=u'pilihan_pendidikan_terakhir', parent=self,
              pos=wx.Point(400, 288), size=wx.Size(216, 25), style=0)

        self.label_pendidikan_tempuh = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_PENDIDIKAN_TEMPUH,
        ...
        self.pilihan_pendidikan_ditempuh = wx.ComboBox(choices=['PAUD sederajat',
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_PENDIDIKAN_DITEMPUH,
              name=u'pilihan_pendidikan_ditempuh', parent=self,
              pos=wx.Point(400, 328), size=wx.Size(216, 25), style=0)

        self.label_pekerjaan = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_PEKERJAAN,
        ...
        self.pilihan_pekerjaan = wx.ComboBox(choices=['Belum / Tidak Bekerja',
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_PEKERJAAN,
              name=u'pilihan_pekerjaan', parent=self, pos=wx.Point(400, 370),
              size=wx.Size(216, 25), style=0)

        self.label_pekerjaan_lainnya = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_PEKERJAAN_LAINNYA,
        ...
        self.pilihan_pekerjaan_lainnya = wx.ComboBox(choices=['Berdagang',
              ...
              'Lainnya'],
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_PEKERJAAN_LAINNYA,
              name=u'pilihan_pekerjaan_lainnya', parent=self, pos=wx.Point(400,
              408), size=wx.Size(216, 25), style=0)

        self.label_status_perkawinan = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_STATUS_PERKAWINAN,
        ...
        self.pilihan_status = wx.ComboBox(choices=['Belum Kawin', 'Kawin',
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_STATUS,
              name=u'pilihan_status', parent=self, pos=wx.Point(624, 208),
              size=wx.Size(248, 25), style=0)

        self.label_status_kependudukan = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_STATUS_KEPENDUDUKAN,
        ...
        self.pilihan_status_kependudukan = wx.ComboBox(choices=['Penduduk Tetap',
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_STATUS_KEPENDUDUKAN,
              name=u'pilihan_status_kependudukan', parent=self,
              pos=wx.Point(624, 248), size=wx.Size(248, 25), style=0)

        self.label_status_tinggal = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_STATUS_TINGGAL,
        ...
        self.pilihan_status_tinggal = wx.ComboBox(choices=['Tinggal Tetap',
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_STATUS_TINGGAL,
              name=u'pilihan_status_tinggal', parent=self, pos=wx.Point(624,
              288), size=wx.Size(248, 25), style=0)

        self.label_difabelitas = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_DIFABELITAS,
        ...
        self.pilihan_difabelitas = wx.ComboBox(choices=['Tidak cacat',
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_DIFABELITAS,
              name=u'pilihan_difabelitas', parent=self, pos=wx.Point(624, 328),
              size=wx.Size(248, 25), style=0)

        self.label_kontrasepsi = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_KONTRASEPSI,
        ...
        self.tombol_tambah_data.Bind(wx.EVT_BUTTON,
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANTOMBOL_TAMBAH_DATA)

        self.kembali = wx.Button(id=wxID_EDIT_KEJADIAN_KELAHIRANKEMBALI,
        ...
        self.kembali.Bind(wx.EVT_BUTTON, self.OnKembaliButton,
              id=wxID_EDIT_KEJADIAN_KELAHIRANKEMBALI)

        self.dokumen = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANDOKUMEN,
              label=u'Catatan Kelahiran', name=u'dokumen', parent=self,
              pos=wx.Point(16, 440), size=wx.Size(304, 17), style=0)

        self.label_data_penduduk = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANLABEL_DATA_PENDUDUK,
              label=u'FORM DATA PENDUDUK', name=u'label_data_penduduk',
              parent=self, pos=wx.Point(336, 0), size=wx.Size(216, 17),
              style=0)

        self.isipenduduk = wx.ListCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANISIPENDUDUK,
        ...
        self.isipenduduk.Bind(wx.EVT_LIST_ITEM_SELECTED,
              ...
              id=wxID_EDIT_KEJADIAN_KELAHIRANISIPENDUDUK)

        self.staticText1 = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT1,
              label=u'Nomor Kartu Keluarga', name='staticText1', parent=self,
              pos=wx.Point(400, 128), size=wx.Size(145, 17), style=0)

        self.cari_kk = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANCARI_KK,
              name=u'cari_kk', parent=self, pos=wx.Point(552, 128),
              size=wx.Size(224, 24), style=0, value='')

        self.tombol_cari = wx.Button(id=wxID_EDIT_KEJADIAN_KELAHIRANTOMBOL_CARI,
        ...
        self.tombol_cari.Bind(wx.EVT_BUTTON, self.OnTombol_cariButton,
              id=wxID_EDIT_KEJADIAN_KELAHIRANTOMBOL_CARI)

        self.input_no = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANINPUT_NO,
              name=u'input_no', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(56, 27), style=0, value=u'')

        self.staticText2 = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT2,
              label=u'RT', name='staticText2', parent=self, pos=wx.Point(760,
              152), size=wx.Size(24, 16), style=0)

        self.staticText3 = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT3,
              label=u'RW', name='staticText3', parent=self, pos=wx.Point(824,
              152), size=wx.Size(19, 17), style=0)

        self.staticText4 = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT4,
              label=u'Yang Melaporkan', name='staticText4', parent=self,
              pos=wx.Point(16, 488), size=wx.Size(118, 17), style=0)

        self.staticText5 = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT5,
              label=u'Keterangan', name='staticText5', parent=self,
              pos=wx.Point(344, 488), size=wx.Size(74, 17), style=0)

        self.tgllahir = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANTGLLAHIR,
              name=u'tgllahir', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(112, 27), style=0, value=u'')

        self.nama_kk = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANNAMA_KK,
              name=u'nama_kk', parent=self, pos=wx.Point(8, 208),
              size=wx.Size(176, 24), style=0, value=u'')

        self.staticText6 = wx.StaticText(id=wxID_EDIT_KEJADIAN_KELAHIRANSTATICTEXT6,
              label=u'Nama Kepala Keluarga', name='staticText6', parent=self,
              pos=wx.Point(8, 192), size=wx.Size(135, 17), style=0)

        self.gambar = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANGAMBAR,
              name=u'gambar', parent=self, pos=wx.Point(8, 376),
              size=wx.Size(176, 24), style=0, value=u'')

        self.button1 = wx.Button(id=wxID_EDIT_KEJADIAN_KELAHIRANBUTTON1,
              label=u'Upload Photo', name='button1', parent=self,
              pos=wx.Point(8, 400), size=wx.Size(176, 32), style=0)
        self.button1.Bind(wx.EVT_BUTTON, self.OnButton1Button,
              id=wxID_EDIT_KEJADIAN_KELAHIRANBUTTON1)

        self.propinsi = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANPROPINSI,
              name=u'propinsi', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(152, 24), style=0, value=u'')

        self.kabupaten = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANKABUPATEN,
              name=u'kabupaten', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(152, 24), style=0, value=u'')

        self.kecamatan = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANKECAMATAN,
              name=u'kecamatan', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(152, 24), style=0, value=u'')

        self.desa = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANDESA,
              name=u'desa', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(152, 24), style=0, value=u'')

        self.simpangambar = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANSIMPANGAMBAR,
              name=u'simpangambar', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(152, 24), style=0, value=u'/opt/sidesa/penduduk')

        self.pilihan_shdk = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_KELAHIRANPILIHAN_SHDK,
              name=u'pilihan_shdk', parent=self, pos=wx.Point(16, 560),
              size=wx.Size(312, 27), style=wx.TE_READONLY, value=u'Anak')
