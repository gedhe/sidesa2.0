#Boa:Frame:edit_kejadian_kematian
...
[wxID_EDIT_KEJADIAN_KEMATIAN, wxID_EDIT_KEJADIAN_KEMATIANCARI_KK, 
 ...
 wxID_EDIT_KEJADIAN_KEMATIANLABEL_DATA_PENDUDUK, 
...
class edit_kejadian_kematian(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(self, id=wxID_EDIT_KEJADIAN_KEMATIAN,
              ...
              style=wx.FRAME_NO_TASKBAR, title=u'Edit Kejadian Kematian')
        ...
        self.label_data_penduduk = wx.StaticText(id=wxID_EDIT_KEJADIAN_KEMATIANLABEL_DATA_PENDUDUK,
